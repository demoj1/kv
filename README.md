...
Все таки реализация тестов на таймаутах ужасное, нестабильное решение.
> По другому не знаю как красиво написать это (×﹏×)

> Запускал в цикле (по while true) тесты, из 427 прогонов, нет зафейлиных тестов, вроде все стабильно,
> параллельно с прогоном аффектил проц всякими бенчами, что бы повызывать случайные задержки
